...
public class AvailabilityCalculationService implements com.service_interface.ledger_service_interface.AvailabilityCalculationService {
    ...
    public void deriveDailyFromMonthly(Long resourceId, YearMonth month) {
        try {
            ...
            List<com.entity.ledger_entities.ResourceAvailabilityLedgerDaily> dailyEntries = new ArrayList<>();
            LocalDate currentDate = monthStart;
            
            while (!currentDate.isAfter(monthEnd)) {
                if (isWorkingDay(currentDate)) {
                    com.entity.ledger_entities.ResourceAvailabilityLedgerDaily daily = createDailyFromMonthly(resourceId, currentDate, monthly);
    ...
    private com.entity.ledger_entities.ResourceAvailabilityLedgerDaily createDailyFromMonthly(Long resourceId, LocalDate date, ResourceAvailabilityLedger monthly) {
        ...
        return com.entity.ledger_entities.ResourceAvailabilityLedgerDaily.builder()
    ...
    public List<com.entity.ledger_entities.ResourceAvailabilityLedgerDaily> getAvailabilityForDateRange(Long resourceId, LocalDate startDate, LocalDate endDate) {
        try {
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<com.entity.ledger_entities.ResourceAvailabilityLedgerDaily> getAvailabilityForDate(Long resourceId, LocalDate date) {
        try {
    ...
    public Map<String, Object> getAvailabilitySummary(Long resourceId, LocalDate startDate, LocalDate endDate) {
        try {
            List<com.entity.ledger_entities.ResourceAvailabilityLedgerDaily> entries = dailyLedgerRepository.findByResourceIdAndDateBetween(resourceId, startDate, endDate);
