...
public class RiskEvaluator {
    ...
    public static String aggregateRisk(String mandatoryGapRisk, String partialRisk, String recencyRisk) {
        ...
        if (RISK_HIGH.equals(mandatoryGapRisk) || RISK_HIGH.equals(partialRisk) || RISK_HIGH.equals(recencyRisk)) {
            return RISK_HIGH;
        } else if (RISK_MEDIUM.equals(mandatoryGapRisk) || RISK_MEDIUM.equals(partialRisk) || RISK_MEDIUM.equals(recencyRisk)) {
            return RISK_MEDIUM;
        } else {
            return RISK_LOW;
        }
